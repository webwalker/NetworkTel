...
//								mContext, 0, createIntent(Sipdroid.class), 0);
			...
			if (enable) {
				if (call_state == UserAgent.UA_STATE_IDLE
						...
						&& PreferenceManager.getDefaultSharedPreferences(
								mContext).getBoolean(
								org.sipdroid.sipua.ui.Settings.PREF_POS,
								org.sipdroid.sipua.ui.Settings.DEFAULT_POS)
						&& PreferenceManager
								.getDefaultSharedPreferences(mContext)
								.getString(
										org.sipdroid.sipua.ui.Settings.PREF_POSURL,
		...
		static void broadcastCallStateChanged(String state,String number) {
			...
			// xujian 2015-02-10，4.4.2下无权发送广播
...
//        		return false;
        	if (SipContext.getUserName().equals("")
				|| SipContext.getIp().equals(""))
			return false;
        	if (wi != null) {
