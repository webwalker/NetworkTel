	...
	public static String isPossible(Context context) {
		...
		email = trunkserver = null;
	   	for (int i = 0; i < SipdroidEngine.LINES; i++) {
	   		...
	   		String username = SipContext.getUserName();
	   		//String server = PreferenceManager.getDefaultSharedPreferences(context).getString(Settings.PREF_SERVER+j, Settings.DEFAULT_SERVER);
	   		String server = SipContext.getIp();
